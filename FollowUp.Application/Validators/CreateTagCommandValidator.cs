    ...
    internal class CreateTagCommandValidator : AbstractValidator<CreateTagCommand>
    {
        public CreateTagCommandValidator()
        {
            RuleFor(_ => _.Name)
                ...
                .Must(name => name.Length >= 1).WithMessage("O Nome da tag deve ter no mínimo 1 caracter")
                .Must(name => name.Length <= 255).WithMessage("O Nome da tag deve ter no máximo 255 caracteres");
        }
    }
}
